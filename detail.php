...
#lightbox-secNav-btnClose {width: 66px; float: right;padding-bottom: 0.7em;	}
        ...
        <a href="bootsshop/assets/products/large/f1.jpg" title="<h4>Fujifilm FinePix S2950 Digital Camera</h4>">
<img src="bootsshop/assets/products/large/3.jpg" width="100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
        </a>
<div id="myCarousel" class="moreOptopm carousel slide">
            <div class="carousel-inner">
              <div class="item active">
               <a href="bootsshop/assets/products/large/f1.jpg"> <img width="29%" src="bootsshop/assets/products/large/f1.jpg" alt=""/></a>
               <a href="bootsshop/assets/products/large/f2.jpg"> <img width="29%" src="bootsshop/assets/products/large/f2.jpg" alt=""/></a>
               <a href="bootsshop/assets/products/large/f3.jpg" > <img width="29%" src="bootsshop/assets/products/large/f3.jpg" alt=""/></a>
              </div>
              <div class="item">
               <a href="bootsshop/assets/products/large/f3.jpg" > <img width="29%" src="bootsshop/assets/products/large/f3.jpg" alt=""/></a>
               <a href="bootsshop/assets/products/large/f1.jpg"> <img width="29%" src="bootsshop/assets/products/large/f1.jpg" alt=""/></a>
