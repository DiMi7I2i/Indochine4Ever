<div class="span9">
	<ul class="breadcrumb">
		...
		<li class="active"><?php echo afficherLibelle('bouton_special_offer') ?></li>
	</ul>
	<h3>
		20% Discount Special offer<small class="pull-right"> 40 products are
			available </small>
	</h3>
	<hr class="soft" />
	<form class="form-horizontal span6">
		<div class="control-group">
			<label class="control-label alignL"><?php echo afficherLibelle('trierPar') ?></label> <select>
			...
			<div class="row">
				...
				<div class="span3 alignR">
					<form class="form-horizontal qtyFrm">
						<h3>$222.00</h3>
						<label class="checkbox"> <input type="checkbox"> Adds product to
							compair
						</label><br /> <a href="product_details.html"
							class="btn btn-large"><i class=" icon-shopping-cart"></i> Add to
							cart</a> <a href="product_details.html" class="btn btn-large">VIEW</a>
					</form>
				</div>
			</div>
			<hr class="soft" />
				...
				<li class="span3">
					<div class="thumbnail">
						<a href="product_details.html"><img
							src="bootsshop/assets/products/4.jpg" alt="" /></a>
						<div class="caption">
							<h5>Manicure &amp; Pedicure</h5>
							<p>Lorem Ipsum is simply dummy text.</p>
							<h4>
								<a class="btn btn-large" href="product_details.html">VIEW</a> <span
	...
	<a href="bootsshop/compair.html" class="btn btn-large pull-right">Compair
		Product</a>
